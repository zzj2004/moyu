...
export const renameFileTool: Tool = {
  ...
  inputSchema: {
    type: "object",
    properties: {
      sourcePath: { type: "string", description: "Current path of the file/directory" },
  ...
  async execute(args: Record<string, unknown>, ctx: ToolContext): Promise<ToolResult> {
    ...
    if (!src || !dst) return { toolName: "file_rename", success: false, output: "", error: "sourcePath and destPath are required" };
